...
import kafka.model.Venda;
import kafka.serializer.VendaSerializer;

public class GeradorVendas {

	private static Random rand = new Random();
	private static long operacao = 0;
	private static BigDecimal valorIngreco = BigDecimal.valueOf(500);
	...
	private static Venda geraVenda() {
		...
		return new Venda(operacao++, cliente, qtdIngressos, valorIngreco.multiply(BigDecimal.valueOf(qtdIngressos)));
	}
}
